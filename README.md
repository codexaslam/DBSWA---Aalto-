...
Average execution duration over 5 queries: 42.856 ms
...
UPDATE students SET year = enrollments.year FROM enrollments WHERE enrollments.student_id = students.id;
```
...
Average execution duration over 5 queries: 16.529 ms
